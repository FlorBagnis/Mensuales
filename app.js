...
/*
Guarda varios meses en una sola operación.
Esto permite guardar un gasto recurrente
de forma mucho más segura.
*/

async function saveMultipleMonthsToFirestore(months) {
...
```
    button.addEventListener(
      ...
      () => {
        ...
        /* Desactivar recurrencia al editar */
...
/*
Devuelve una fecha YYYY-MM-DD.

Si el día solicitado no existe en ese mes,
utiliza automáticamente el último día
disponible.

Ejemplo:
Día 31 + febrero = 28/29
Día 31 + abril = 30
*/

function createRecurringDate(
originalDate,
monthsToAdd,
desiredDay
) {
...
/*
Crea todas las fechas de una recurrencia.
*/
...
```
  ...
  if (
    ...
    alert(
      "El intervalo debe ser de entre 1 y 12 meses."
    );
  ...
  if (
    ...
    alert(
      "La duración debe estar entre 1 y 120 meses."
    );
  ...
  /*
    ...
    anterior por si Firebase falla.
  */
  ...
  */
  ...
  try {
    ...
    await saveMultipleMonthsToFirestore(
      monthsToSave
    );
    ...
    */
    ...
    alert(
      "No se pudo guardar el gasto recurrente en Firebase. No se realizaron cambios."
    );
